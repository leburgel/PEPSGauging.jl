"""
Test MCF-based optimization, used fixed-point differentiation of gauge-fixing procedure.
"""
...
lattice = InfiniteSquare(2, 2) # try this out...
...
peps0 = peps_normalize(InfinitePEPS(fill(P, size(lattice)...), fill(Vpeps, size(lattice)...)))
...
jldsave("mcf_fixed_peps_20_iter.jld2"; peps, ctmrg_env, H)
...
data = load("mcf_fixed_peps_20_iter.jld2")
peps = data["peps"]
...
save("mcf_fixed_before_nogauge.png", fig_before_nogauge)
save("mcf_fixed_before_gauge.png", fig_before_gauge)
save("mcf_fixed_after_nogauge.png", fig_after_nogauge)
save("mcf_fixed_after_gauge.png", fig_after_gauge)
